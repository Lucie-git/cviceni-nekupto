...
product1Elm.innerHTML += `<img class="card-img-top" src=${product1.image} alt="Card image cap">
  <div class="card-body">
...
product2Elm.innerHTML += `<img class="card-img-top" src=${product2.image} alt="Card image cap">
    <div class="card-body">
...
product3Elm.innerHTML += `<img class="card-img-top" src=${product3.image} alt="Card image cap">
  <div class="card-body">
